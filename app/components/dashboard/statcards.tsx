export default function StatCards() {
    return (
        <div className="max-w-[85rem] py-3 lg:py-5 mx-auto">
            <div className="grid md:grid-cols-4 border border-gray-200 shadow-sm rounded-xl overflow-hidden">
                <a
                    className="block p-4 md:p-5 relative bg-white hover:bg-gray-50 before:absolute before:top-0 before:left-0 before:w-full before:h-px md:before:w-px md:before:h-full before:bg-gray-200 before:first:bg-transparent"
                    href="#"
                >
                    <div className="flex md:grid lg:flex gap-y-3 gap-x-5">
                        ...
                        <div className="grow">
                            ...
                            <div className="mt-1 flex justify-between items-center">
                                ...
                                <span className="ml-1 inline-flex items-center gap-1.5 py-1 px-2 rounded-md text-xs font-medium bg-gray-200 text-gray-800">
                                    <svg
